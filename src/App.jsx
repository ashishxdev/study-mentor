            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                ...
                <button
                  ...
                  className="flex-1 sm:flex-none inline-flex items-center justify-center px-6 py-4 rounded-xl bg-emerald-500/20 border border-emerald-500/40 text-emerald-200 hover:bg-emerald-500/30 hover:border-emerald-400/60 hover:text-emerald-100 transition-all duration-200 shadow-lg font-medium"
                >
  ...
  return (
    <div className="flex min-h-screen bg-slate-900">
      ...
      <main className="flex-1 lg:ml-68">
        <header className="sticky top-0 bg-gradient-to-r from-white/10 via-white/5 to-white/10 backdrop-blur-lg border-b border-white/20 z-50 shadow-lg">
          <div className="px-3 sm:px-6 lg:px-12 py-3 sm:py-4 lg:py-6 flex items-center justify-between">
